...
class ChildCare(models.Model):
    ...
    given_food = models.DecimalField(max_digits=4, decimal_places=2, verbose_name="Given complimentary food", null=True)
    newborn_screening = models.DecimalField(max_digits=4, decimal_places=2, verbose_name="Infant for newborn screening", null=True)
    infants_received_vitamin_A = models.DecimalField(max_digits=4, decimal_places=2, verbose_name="Infants who received Vitamin A", null=True)
    infants_received_iron = models.DecimalField(max_digits=4, decimal_places=2, verbose_name="Infants who received Iron", null=True)
    infants_received_MNP = models.DecimalField(max_digits=4, decimal_places=2, verbose_name="Infants who received MNP", null=True)
    sick_children = models.DecimalField(max_digits=4, decimal_places=2, null=True)
    given_deworming = models.DecimalField(max_digits=4, decimal_places=2, null=True)
    anemic_children = models.DecimalField(max_digits=4, decimal_places=2, null=True)
    anemic_with_iron = models.DecimalField(max_digits=4, decimal_places=2, null=True)
    diarrhea_cases = models.DecimalField(max_digits=4, decimal_places=2, null=True)
    diarrhea_with_ors = models.DecimalField(max_digits=4, decimal_places=2, null=True)
    pneumonia_cases = models.DecimalField(max_digits=4, decimal_places=2, null=True)
    pneumonia_with_tx = models.DecimalField(max_digits=4, decimal_places=2, null=True)
